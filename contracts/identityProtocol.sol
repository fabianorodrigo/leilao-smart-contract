...
/**
 * This contract can represent identity, and allows for the addition of attributes to this identity.
 */
...
contract IdentityProtocol {
    ...
    /**
     * Constructor of the Identity Protocol
     */
    function IdentityProtocol() public {
        owner = msg.sender;
        override = owner;
